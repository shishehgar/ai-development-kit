...
import type { ProjectPathResult } from '../types/api'

export function ProjectsPage() {
  const [path, setPath] = useState('')
  const [result, setResult] =
    useState<ProjectPathResult | null>(null)
  ...
  return (
    <Stack spacing={3}>
          ...
          >
            <Stack spacing={2}>
              <TextField
                ...
                placeholder={
                  '/home/ubuntu/my_services/projects/example'
                }
                slotProps={{
                  htmlInput: {
                    dir: 'ltr',
      ...
      {result ? (
        <Alert
          severity={result.allowed ? 'success' : 'warning'}
        >
          <Stack spacing={1}>
